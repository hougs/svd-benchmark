...
def process_one_param_set(wd, n_rows, n_cols, frac, lan_rank, stoch_rank, block_size, master, spark_home, project_home, hdfs_root, csv_writer):
    ...
    with open('results/experiment.csv', 'wb') as exp_rez:
        ...
        for n_rows in rows:
            for sparse_frac in frac:
                process_one_param_set(wd, n_rows, n_cols, sparse_frac, lan_rank, stoch_rank, block_size, master,
